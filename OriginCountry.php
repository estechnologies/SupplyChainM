                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                                    <form method="post" action="MaterialGroupBack.php">
                                                        ...
                                                        <td>
                                                            <center><input type = "text" name="CountryName" required style="width: 150px;" minlength="<?php echo $CountryNameMin;?>" maxlength="<?php echo $CountryNameMax; ?>"  pattern="<?php echo $CountryNamePattern; ?>"  id="MaterialGroupDescription1" value="<?php echo $originCountryData[$i][2]; ?>" onkeyup="expand(this);" class="form-control input-md"></center>
                                                        </td>
                                                        <td>
                                           ...
                                           <?php  }else { ?>
                                                ...
                                                <tr>
                                                    <form method="post" action="OriginCountryBack.php">
                                                        ...
                                                        <td>
                                                            <center><input type = "text" name="CountryName" required minlength="<?php echo $CountryNameMin;?>" maxlength="<?php echo $CountryNameMax; ?>"  pattern="<?php echo $CountryNamePattern; ?>"  id="MaterialGroupDescription1" value="" onkeyup="expand(this);" class="form-control input-md"></center>
                                                        </td>
                                                        <td>
                                                        <button type="submit" name="login-submit" id="login-submit"  class="btn btn-default">Submit</button>
  </form>
